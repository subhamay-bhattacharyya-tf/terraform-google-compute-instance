...
### Google Compute Instance Module — Annotated Example
...
# Core compute instance resource
...
|---|---|---|
| `e2` | Cost-optimised general purpose | `e2-micro`, `e2-small`, `e2-medium` |
| `n1` | Flexible general purpose (older gen) | `n1-standard-1`, `n1-standard-4` |
| `n2` | Balanced general purpose | `n2-standard-2`, `n2-standard-8` |
| `c2` | Compute-optimised | `c2-standard-4`, `c2-standard-16` |
| `m1`/`m2` | Memory-optimised | `m1-ultramem-40` |

### GCP Boot Disk Types

| Type | Use Case |
|---|---|
| `pd-standard` | HDD — lowest cost, sequential workloads |
| `pd-balanced` | SSD — balanced price/performance |
| `pd-ssd` | SSD — highest IOPS, latency-sensitive workloads |
