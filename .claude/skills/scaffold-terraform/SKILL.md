...
description: Generate complete Terraform Google Module for provisioning a Google Compute Instance with the given specifications
disable-model-invocation: true
argument-hint: "[region] [project]"
---

Generate a complete Terraform Google Module for provisioning a Google Compute Instance with the given specifications:
...
|---|---|
| `variables.tf` | **`tf-mod-vars`** — follow its variable authoring patterns, validation rules, and GCP provider reference for the `compute_instance_config` object |
| `main.tf` | **`tf-mod-main`** — follow its core authoring patterns and GCP provider reference for the `google_compute_instance` resource |
